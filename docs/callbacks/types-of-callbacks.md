...
??? "Code"
    ...
    ```ts
    --8<-- "examples/typescript/snippets/callbacks/before-agent-callback.ts"
    ```
...
??? "Code"
    ...
    ```ts
    --8<-- "examples/typescript/snippets/callbacks/after-agent-callback.ts"
    ```
...
??? "Code"
    ...
    ```ts
    --8<-- "examples/typescript/snippets/callbacks/before-model-callback.ts"
    ```
...
??? "Code"
    ...
    ```ts
    --8<-- "examples/typescript/snippets/callbacks/after-model-callback.ts"
    ```
...
??? "Code"
    ...
    ```ts
    --8<-- "examples/typescript/snippets/callbacks/before-tool-callback.ts"
    ```
...
??? "Code"
    ...
    ```ts
    --8<-- "examples/typescript/snippets/callbacks/after-tool-callback.ts"
    ```