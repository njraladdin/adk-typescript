...
function getCapitalCity(country: string): string {
  /**
...
const myLlmAgent = new LlmAgent("ToolCallbackAgent", {
  model: model,
...
export function runBeforeToolCallbackDemo(query: string): void {
  callAgent(query);
} 