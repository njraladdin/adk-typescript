...
[ADK TypeScript API Reference](../../../modules.md) / [tools/LongRunningTool](../README.md) / LongRunningFunctionTool

# Class: LongRunningFunctionTool

Defined in: [src/tools/LongRunningTool.ts:32](https://github.com/njraladdin/adk-typescript/blob/main/src/tools/LongRunningTool.ts#L32)
...
- [`GetUserChoiceTool`](../../GetUserChoiceTool/classes/GetUserChoiceTool.md)
...
> **new LongRunningFunctionTool**(`options`): `LongRunningFunctionTool`

Defined in: [src/tools/LongRunningTool.ts:38](https://github.com/njraladdin/adk-typescript/blob/main/src/tools/LongRunningTool.ts#L38)
...
Options for the long-running function tool
