...
[ADK TypeScript API Reference](../../../modules.md) / [agents/SequentialAgent](../README.md) / SequentialAgent

# Class: SequentialAgent

Defined in: [src/agents/SequentialAgent.ts:23](https://github.com/njraladdin/adk-typescript/blob/main/src/agents/SequentialAgent.ts#L23)
...
> **new SequentialAgent**(`name`, `options`): `SequentialAgent`
...
Defined in: [src/agents/SequentialAgent.ts:37](https://github.com/njraladdin/adk-typescript/blob/main/src/agents/SequentialAgent.ts#L37)
...
Defined in: [src/agents/SequentialAgent.ts:46](https://github.com/njraladdin/adk-typescript/blob/main/src/agents/SequentialAgent.ts#L46)
...
Defined in: [src/agents/SequentialAgent.ts:30](https://github.com/njraladdin/adk-typescript/blob/main/src/agents/SequentialAgent.ts#L30)
