...
import { SessionInterface as Session } from '../../../src/sessions/types';
...
export class TestRunner {
  ...
  private currentSessionId: string = 'initializing';
  ...
  constructor(
    ...
    this.sessionInitialized = this._initializeSession();
  }
  ...
  async run(prompt: string): Promise<any[]> {
    // Make sure session is initialized before running
    await this.sessionInitialized;
    ...
    // Wait a short time to ensure any async operations complete
